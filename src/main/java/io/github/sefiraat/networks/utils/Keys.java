...
public class Keys {
    ...
    public static final NamespacedKey AE_CELL_CLEANER_MARKER = newKey("ae_cell_cleaner_marker");
    public static final NamespacedKey AE_CELL_CONVERTER_MARKER = newKey("ae_cell_converter_marker");
